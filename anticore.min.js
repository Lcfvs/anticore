...
t=this,t.element=e,m(x[t.selector],c,t)}function c(e){this.push([e,this.element,this.loaded])}function h(e,t){return new Promise(function(n){var r
r=[],r.container=e,r.loaded=t,m(Object.keys(x),s,r),r.next=i.bind(r,n),r.next()})}var a,f,l,d,p,m,v,q,g,x,b,y,j
